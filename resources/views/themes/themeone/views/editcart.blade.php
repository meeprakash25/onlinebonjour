                                ...
                                <div class="product-summary">
                                    ...
                                    <div class="product-price">
                                        @if(!empty($result['detail']['product_data'][0]->flash_price))
                                            <span class="discount">
                                                @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                    {{'S$' .round((($result['detail']['product_data'][0]->flash_price+0) * round((1/session('countryCurrency')),3)),2)}}
                                                @elseif(session('currency') == 'usd' && session()->has('countryCurrency'))
                                                    {{'USD' .round((($result['detail']['product_data'][0]->flash_price+0) * round((1/session('countryCurrency')),4)),2)}}
                                                @else
                                        ...
                                        @elseif(!empty($result['detail']['product_data'][0]->discount_price))
                                            <span class="discount">
                                                @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                    {{'S$' .round((($result['detail']['product_data'][0]->discount_price+0) * round((1/session('countryCurrency')),3)),2)}}
                                                @elseif(session('currency') == 'usd' && session()->has('countryCurrency'))
                                                    {{'USD' .round((($result['detail']['product_data'][0]->discount_price+0) * round((1/session('countryCurrency')),4)),2)}}
                                                @else
                                        ...
                                        <!--discount_price-->
                                         <span class="price @if(!empty($result['detail']['product_data'][0]->discount_price) or !empty($result['detail']['product_data'][0]->flash_price)) line-through @else change_price @endif" >
                                            @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                 {{'S$' .round((($result['detail']['product_data'][0]->products_price+0) * round((1/session('countryCurrency')),3)),2)}}
                                            @elseif(session('currency') == 'usd' && session()->has('countryCurrency'))
                                                 {{'USD' .round((($result['detail']['product_data'][0]->products_price+0) * round((1/session('countryCurrency')),4)),2)}}
                                             @else
                                        ...
                                        <div class="form-inline product-box">
                                            ...
                                            <div class="price-box">
                                                ...
                                                <span class="total_price">
                                                    ...
                                                    @endif
                                                        @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                            {{'S$' .round((($result['cart'][0]->final_price*$result['cart'][0]->customers_basket_quantity) * round((1/session('countryCurrency')),3)),2)}}
                                                        @elseif(session('currency') == 'usd' && session()->has('countryCurrency'))
                                                            {{'USD' .round((($result['cart'][0]->final_price*$result['cart'][0]->customers_basket_quantity) * round((1/session('countryCurrency')),4)),2)}}
                                                        @else
