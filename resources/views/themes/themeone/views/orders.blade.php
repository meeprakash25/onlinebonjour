                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                {{'S$' .round((($orders->order_price) * round((1/session('countryCurrency')),3)),2)}}
                                            @elseif(session('currency') == 'usd' && session()->has('countryCurrency'))
                                                {{'USD' .round((($orders->order_price) * round((1/session('countryCurrency')),4)),2)}}
                                            @else
                                                {{$web_setting[19]->value}}{{$orders->order_price}}
                                            @endif
