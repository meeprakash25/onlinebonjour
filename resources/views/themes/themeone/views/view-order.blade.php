                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" class="price"><span>
                                                            @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                                {{'S$' .round((($products->final_price/$products->products_quantity) * round((1/session('countryCurrency')),3)),2)}}
                                                            @elseif(session('currency') == 'usd' && session()->has('countryCurrency'))
                                                                {{'USD' .round((($products->final_price/$products->products_quantity) * round((1/session('countryCurrency')),4)),2)}}
                                                            @else
                                                                {{$web_setting[19]->value}}{{$products->final_price/$products->products_quantity}}
                                                            @endif
{{--                                                            {{$result['orders'][0]->currency}}{{$products->final_price/$products->products_quantity}}--}}
                                                        </span></td>
                                                    ...
                                                    <td align="right" class="subtotal"><span>
                                                            ...
                                                            @endif
{{--                                                            {{$result['orders'][0]->currency}}{{$products->final_price+0}}--}}
                                                        </span>
                                                    </td>
                                                </tr>    
                                                @endforeach
                                                ...
                                                <thead>
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                        ...
                                                        <td valign="middle" align="right" id="subtotal">
                                                            @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                            ...
                                                            @endif
{{--                                                            {{$result['orders'][0]->currency}}{{$price+0}}--}}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td valign="middle" align="right">
                                                            @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                                {{'S$' .round((($result['orders'][0]->total_tax) * round((1/session('countryCurrency')),3)),2)}}
                                                            @elseif(session('currency') == 'usd' && session()->has('countryCurrency'))
                                                                {{'USD' .round((($result['orders'][0]->total_tax) * round((1/session('countryCurrency')),4)),2)}}
                                                            @else
                                                                {{$web_setting[19]->value}}{{$result['orders'][0]->total_tax}}
                                                            @endif
{{--                                                            {{$result['orders'][0]->currency}}{{$result['orders'][0]->total_tax}}--}}
                                                        </td>
                                                    </tr>
{{--                                                    {{dd($result['orders'][0])}}--}}
                                                    <tr>
                                                        ...
                                                        <td valign="middle" align="right">
                                                            @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                                {{'S$' .round((($result['orders'][0]->shipping_cost) * round((1/session('countryCurrency')),3)),2)}}
                                                            @elseif(session('currency') == 'usd' && session()->has('countryCurrency'))
                                                                {{'USD' .round((($result['orders'][0]->shipping_cost) * round((1/session('countryCurrency')),4)),2)}}
                                                            @else
                                                                {{$web_setting[19]->value}}{{$result['orders'][0]->shipping_cost}}
                                                            @endif
{{--                                                            {{$result['orders'][0]->currency}}{{$result['orders'][0]->shipping_cost}}--}}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th><span>@lang('website.Discount(Coupon)')</span></th>
                                                        <td valign="middle" align="right" id="discount">
                                                            @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                                {{'S$' .round(((number_format((float)$result['orders'][0]->coupon_amount, 2, '.', '')) * round((1/session('countryCurrency')),3)),2)}}
                                                            @elseif(session('currency') == 'usd' && session()->has('countryCurrency'))
                                                                {{'USD' .round(((number_format((float)$result['orders'][0]->coupon_amount, 2, '.', '')) * round((1/session('countryCurrency')),4)),2)}}
                                                            @else
                                                                {{$web_setting[19]->value}}{{number_format((float)$result['orders'][0]->coupon_amount, 2, '.', '')}}
                                                            @endif
{{--                                                            {{$result['orders'][0]->currency}}{{number_format((float)$result['orders'][0]->coupon_amount, 2, '.', '')+0}}--}}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="last"><span>@lang('website.Total')</span></th>
                                                        <td class="last" valign="middle" align="right" id="total_price">
                                                            @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                                {{'S$' .round(((number_format((float)$result['orders'][0]->order_price+0, 2, '.', '')) * round((1/session('countryCurrency')),3)),2)}}
                                                            @elseif(session('currency') == 'usd' && session()->has('countryCurrency'))
                                                                {{'USD' .round(((number_format((float)$result['orders'][0]->order_price+0, 2, '.', '')) * round((1/session('countryCurrency')),4)),2)}}
                                                            @else
                                                                {{$web_setting[19]->value}}{{number_format((float)$result['orders'][0]->order_price+0, 2, '.', '')}}
                                                            @endif
{{--                                                            {{$result['orders'][0]->currency}}{{number_format((float)$result['orders'][0]->order_price+0, 2, '.', '')+0}}--}}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
