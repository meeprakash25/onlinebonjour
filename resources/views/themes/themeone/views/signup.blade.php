		...
		<div class="row">
			<div class="col-12 col-md-6 col-lg-7 new-customers">
				...
				<form name="signup" enctype="multipart/form-data" class="form-validate" action="{{ URL::to('/signupProcess')}}" method="post">
					...
					<div class="form-group row">
						<label for="inputPassword" class="col-sm-4 col-form-label"><strong>*</strong>Phone</label>
						<div class="col-sm-8">
							<input type="text" name="phone" id="phone" class="form-control phone-validate" value="{{ old('phone') }}">
