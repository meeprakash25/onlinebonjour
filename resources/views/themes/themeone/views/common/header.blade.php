                        ...
                        <div class="navbar-brand">
                            <form action="{{route('changeCurrency')}}" method="post">
                                ...
                                <select name="change_countryCurrency" id="change_language" class="change-language">
                                    <option value="nrp" @if(session('currency') != 'sgd') selected @endif data-class="nrp" data-style="background-image: url('public/images/nepal.png'); height: 20px;" selected>NPR</option>
                                    <option value="sgd" @if(session('currency') == 'sgd') selected @endif data-class="sgd" data-style="background-image: url('public/images/singapore.png'); height: 20px;">SGD</option>
                                    <option value="usd" @if(session('currency') == 'usd') selected @endif data-class="usd" data-style="background-image: url('public/images/eng.png'); height: 20px;">USD</option>
                                </select>
                            </form>
                        </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbar_collapse_0">
                            <ul class="navbar-nav">
                                ...
                                @if (Auth::guard('customer')->check())
                                    <li class="nav-item">
                                        <div class="nav-link">
                                            <span class="p-pic"><img src="{{asset('').auth()->guard('customer')->user()->customers_picture}}" alt="image"></span>
                                            @lang('website.Welcome')&nbsp;<a href="{{ URL::to('/profile')}}" >
