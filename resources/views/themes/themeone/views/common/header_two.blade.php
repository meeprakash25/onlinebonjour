                    ...
                    <nav id="navbar_0" class="navbar navbar-expand-md navbar-dark navbar-0 p-0">
                        <div class="navbar-brand">
                            <form action="{{route('changeCurrency')}}" method="post">
                                {{csrf_field()}}
                                <select name="change_countryCurrency" id="change_language" class="change-language">
                                    <option value="nrp" @if(session('currency') != 'sgd') selected @endif data-class="nrp"
                                            data-style="background-image: url('public/images/nepal.png'); height: 20px;" selected>NPR
                                    </option>
                                    <option value="sgd" @if(session('currency') == 'sgd') selected @endif data-class="sgd"
                                            data-style="background-image: url('public/images/singapore.png'); height: 20px;">SGD
                                    </option>
                                    <option value="usd" @if(session('currency') == 'usd') selected @endif data-class="usd"
                                            data-style="background-image: url('public/images/eng.png'); height: 20px;">USD
                                    </option>
                                </select>
                            </form>
                        </div>
                        <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navbar_collapse_0"
                                aria-controls="navbar_collapse_0" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12">
                        ...
                        <div class="collapse navbar-collapse" id="navbar_collapse_1">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown dropdown-main">
                                    ...
                                    <a href="" class="nav-link " id="navbarDropdownMenuLink00" data-toggle="dropdown" aria-haspopup="true"
                                       aria-expanded="false"> <i class="fa fa-align-right" aria-hidden="true"></i>@lang('website.All Categories') <i
                                                class="fa fa-angle-down" aria-hidden="true"></i></a>

                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink00">
                                        @foreach($result['commonContent']['categories'] as $categories_data)
                                            <li>
                                                <a class="dropdown-item" href="{{ URL::to('/shop')}}?category={{$categories_data->slug}}"><img
                                                            class="img-fuild" src="{{asset('').$categories_data->icon}}">{{$categories_data->name}}
                                                    @if(count($categories_data->sub_categories)>0)
                                ...
                                <li class="nav-item last"><a
                                            class="nav-link"><span>@lang('website.hotline')</span>({{$result['commonContent']['setting'][11]->value}})</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
                    ...
                    <nav id="navbar_2" class="navbar navbar-expand-lg navbar-dark navbar-2 p-0 d-block d-lg-none">
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar_collapse_2"
                                aria-controls="navbar_collapse_2" aria-expanded="false" aria-label="Toggle navigation"> @lang('website.Menu') </button>
                        ...
                        <div class="collapse navbar-collapse" id="navbar_collapse_2">
                            ...
                            <ul class="navbar-nav">
                               ...
                               <li class="nav-item"><a class="nav-link" href="{{ URL::to('/brands')}}">Brands</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{ URL::to('/contact-us')}}">@lang('website.Contact Us')</a></li>
                                <li class="nav-item dropdown open">
                                    <div class="nav-link dropdown-toggle">More</div>
                                ...
                                <li class="nav-item last">
                                    <a class="nav-link"><span>@lang('website.hotline')</span>({{$result['commonContent']['setting'][11]->value}})</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
