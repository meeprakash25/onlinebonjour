...
<head>
    ...
    @else
    <title><?=stripslashes($result['commonContent']['setting'][18]->value)?>  @if(!empty($result['commonContent']['setting'][79]->value))- <?=stripslashes($result['commonContent']['setting'][79]->value)?> @endif</title>
    @endif
    ...
    <link rel="stylesheet" href="{{asset('public/fonts/logo/stylesheet.css')}}" type="text/css">
