                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-9 new-customers">
                        <div class="col-12 spaceright-0">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <form name="updateMyProfile" class="form-validate" enctype="multipart/form-data"
                                          action="{{ URL::to('updateMyProfile')}}" method="post">
                                        @if( count($errors) > 0)
                                                ...
                                                <div class="upload-picture">
                                                    <div class="uploaded-image" id="uploaded_image">
                                                        @if(!empty(auth()->guard('customer')->user()->customers_picture))
                                                            <img src="{{asset('').auth()->guard('customer')->user()->customers_picture}}" width="150px"
                                                                 height="150px" class="upload-preview">
                                                            <input type="hidden" name="customers_old_picture"
                                                                   value="{{ auth()->guard('customer')->user()->customers_picture }}">
                                                        @else
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="customers_firstname" class="form-control field-validate"
                                                       placeholder="@lang('website.First Name')" id="firstName"
                                                       value="{{ auth()->guard('customer')->user()->customers_firstname }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="customers_lastname" placeholder="@lang('website.Last Name')"
                                                       class="form-control field-validate" id="lastName"
                                                       value="{{ auth()->guard('customer')->user()->customers_lastname }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="custom-select field-validation" name="customers_gender" id="gender">
                                                    <option value="0"
                                                            @if(auth()->guard('customer')->user()->customers_gender == 0) selected @endif>@lang('website.Male')</option>
                                                    <option value="1"
                                                            @if(auth()->guard('customer')->user()->customers_gender == 1) selected @endif>@lang('website.Female')</option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input readonly name="customers_dob" type="text" class="form-control" id="datepicker"
                                                       placeholder="@lang('website.Date of Birth')"
                                                       value="{{ auth()->guard('customer')->user()->customers_dob }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input name="customers_telephone" type="tel" class="form-control number-validate" id="phone"
                                                       placeholder="@lang('website.Phone Number')"
                                                       value="{{ auth()->guard('customer')->user()->customers_telephone }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input name="customer_email" type="email" class="form-control email-validate" id="email" disabled
                                                       placeholder="Email"
                                    ...
                                    <hr class="featurette-divider">
                                    <form name="updateMyPassword" class="" enctype="multipart/form-data" action="{{ URL::to('/updateMyPassword')}}"
                                          method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <span class="help-block error-content"
                                                      hidden>@lang('website.Please enter your password and should be at least 6 characters long')</span>
                                            </div>
                                        </div>
                                        <div class="button">
                                            <button type="submit" class="btn btn-dark">@lang('website.Update')</button>
