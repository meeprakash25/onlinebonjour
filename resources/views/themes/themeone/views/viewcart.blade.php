                                  	...
                                  	<tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" id="discount">
                                                @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                    <span>{{'S$' .round(((number_format((float)session('coupon_discount'), 2, '.', '')+0) * round((1/session('countryCurrency')),3)),2)}}</span>
                                                @elseif(session('currency') == 'usd' && session()->has('countryCurrency'))
                                                    <span>{{'USD' .round(((number_format((float)session('coupon_discount'), 2, '.', '')+0) * round((1/session('countryCurrency')),4)),2)}}</span>
                                                @else
                                        ...
                                        <tr>
                                            ...
                                            <td class="last" align="right" id="total_price">
                                                @if(session('currency') == 'sgd' && session()->has('countryCurrency'))
                                                    <span>{{'S$' .round((($price+0-number_format((float)session('coupon_discount'), 2, '.', '')) * round((1/session('countryCurrency')),3)),2)}}</span>
                                                @elseif(session('currency') == 'usd' && session()->has('countryCurrency'))
                                                    <span>{{'USD' .round((($price+0-number_format((float)session('coupon_discount'), 2, '.', '')) * round((1/session('countryCurrency')),4)),2)}}</span>
                                                @else
                                                    {{$web_setting[19]->value}}{{$price+0-number_format((float)session('coupon_discount'), 2, '.', '')}}
                                                @endif
                                            </td>
                                        </tr>
                                	</tbody>
