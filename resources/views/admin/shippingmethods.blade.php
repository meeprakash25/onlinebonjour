                            ...
                            <td>
                                 ...
                                 @if($shipping_methods->methods_type_link=='shippingByWeight' and $shipping_methods->shipping_methods_id=='5')
                                   ...
                                   <td>---</td>
                                    ...
                                    <td> <a href="{{ URL::to('admin/shppingbyweight/')}}" class="badge bg-light-blue">Manage Price By Weight</a>    </td>
                                 @endif

                            @if($shipping_methods->methods_type_link=='ShippingByLocation' and $shipping_methods->shipping_methods_id=='6')
                                   ...
                                   <td>---</td>
                                    ...
                                    <td> <a href="{{ URL::to('admin/shippingbylocation/')}}" class="badge bg-light-blue">Manage Price By Location</a>    </td>
                                 @endif
