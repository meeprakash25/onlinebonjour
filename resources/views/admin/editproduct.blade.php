...
{{--                                <hr>--}}
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      {!! Form::text('discount_price',  $result['product'][0]->discount_price, array('class'=>'form-control discount-validate', 'id'=>'discount_price')) !!}
                                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
...
<script type="text/javascript">
    jQuery(document).on('keyup', '.discount-validate', function(e){
		...
		$(function () {
            var discount_amt = $('#discount_price').val();
            console.log(discount_amt);
            if(discount_amt == '' || isNaN(discount_amt)) {
                jQuery(this).closest(".form-group").addClass('has-error');
                jQuery(this).next(".error-content").removeAttr('hidden');
            }else{
                jQuery(this).closest(".form-group").removeClass('has-error');
