...
{{--                                </div>--}}
                              ...
                              @foreach($result['languages'] as $languages)
                                ...
                                <div class="form-group">
                                      <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ProductName') }}</label>
                                      <div class="col-sm-10 col-md-4">
                                ...
                                <div class="form-group external_link" style="display: none">
                                      <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.External URL') }}</label>
                                      <div class="col-sm-10 col-md-4">
