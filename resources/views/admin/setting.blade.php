                        ...
                        <!-- form start -->
                         <div class="box-body">
                          ...
                          @endif
                            ...
                            <div class="form-group">
                              <label for="name" class="col-sm-2 col-md-3 control-label">Singapore Dollar Value</label>
                              <div class="col-sm-10 col-md-4">
                                  {!! Form::text($result['settings'][92]->name, $result['settings'][92]->value, array('class'=>'form-control', 'id'=>$result['settings'][92]->name)) !!}<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">Singapore Dollar today's rate in Nepal</span>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="name" class="col-sm-2 col-md-3 control-label">US Dollar Value</label>
                              <div class="col-sm-10 col-md-4">
                                  {!! Form::text($result['settings'][93]->name, $result['settings'][93]->value, array('class'=>'form-control', 'id'=>$result['settings'][93]->name)) !!}<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">US Dollar today's rate in Nepal</span>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10 col-md-4">
                                {!! Form::file($result['settings'][86]->name, array('id'=>$result['settings'][86]->name)) !!}<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.FaviconText') }}</span>
                                <br>
                                {!! Form::hidden('oldImage',  $result['settings'][86]->value , array('id'=>$result['settings'][15]->name)) !!}
