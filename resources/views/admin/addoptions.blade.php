              	  ...
              	  <div class="box box-info"><br>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/addnewoptions', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
							...
							<div class="box-footer text-center">
								<button type="submit" class="btn btn-primary">{{ trans('labels.AddOptions') }}</button>
