    ...
    Route::group(['namespace' => 'Admin'], function () {
        ...
        Route::group(['middleware' => 'admin'], function () {
            ...
            */
            ...
            Route::get('/deletecategory/{id}', 'AdminCategoriesController@deletecategory')->name('deleteCategory');
            ...
            //shppingbylocationprice
            Route::get('/shippingbylocation', 'AdminShippingByLocationController@shppingbylocation');
            Route::post('/updateShippingLocationPrice', 'AdminShippingByLocationController@updateShppingLocationPrice');
...
Route::group(['namespace' => 'Web'], function () {
    ...
    Route::post('/currencyChange', 'WebSettingController@changeCurrency')->name('changeCurrency');
...
//    search by brands
    Route::get('/brand-search', 'ProductsController@brandSearch');
    Route::post('/brand-search', 'ProductsController@brandSearch');
    /*
    |--------------------------------------------------------------------------
