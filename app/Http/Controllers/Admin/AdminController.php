...
class AdminController extends Controller
{
    ...
    public function login()
    {
        if (Auth::check()) {
            ...
            return view("admin.login", $title, $countryCurrency);
        }
    }
    ...
    public function admininfo()
    {
        ...
        $title      = array('pageTitle' => Lang::get("labels.login_page_name"));
        return view("admin.login", $title, $administor);
    }
    ...
    public function checkLogin(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if (auth()->guard('admin')->attempt($credentials)) {
                ...
                return redirect('admin/login')->with('loginError', Lang::get("labels.EmailPasswordIncorrectText"))->withInput();
            }
