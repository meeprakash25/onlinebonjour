    ...
    public function products($data)
    {
        ...
        elseif ($type == "special") {
            $categories->LeftJoin('specials', 'specials.products_id', '=', 'products.products_id')
                ->select('products.*', 'products_description.*', 'manufacturers.*', 'manufacturers_info.manufacturers_url', 'products.discount_price as discount_price', 'products.discount_price as discount_price');
            ...
            })->select('products.*', 'products_description.*', 'manufacturers.*', 'manufacturers_info.manufacturers_url', 'products.discount_price as discount_price');
        }
        ...
        // for products by brands
        if (!empty($data['manufacturers_id']) && $data['manufacturers_id'] != "") {
            $categories->where('manufacturers.manufacturers_id', $data['manufacturers_id']);
        }
